...
/**
    ...
    fun insetBy(dy: Int): Int {
        ...
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
            insetTo(controller.currentInsets.bottom - dy)
        } else {
...
/**
    ...
    fun insetTo(inset: Int): Int {
        ...
        val hiddenBottom = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
...
/**
    ...
    fun finish() {
        ...
        val current = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
            controller.currentInsets.bottom
        } else {
            TODO("VERSION.SDK_INT < R")
        }
...
/**
    ...
    private fun animateImeToVisibility(
        ...
        currentSpringAnimation = springAnimationOf(
                ...
                getter = { if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                    controller.currentInsets.bottom.toFloat()
                } else {
                    TODO("VERSION.SDK_INT < R")
                }
                },
